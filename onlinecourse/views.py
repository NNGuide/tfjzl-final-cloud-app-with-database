...
def submit(request, course_id):
    course = get_object_or_404(Course, pk=course_id)
    user = request.user # Get user and course object 
    enrollment = Enrollment.objects.get(user=user, course=course) # get the associated enrollment object created when the user enrolled the course
    ...
    return HttpResponseRedirect(reverse(viewname='onlinecourse:exam_result', args=(course_id, submission_id,))) # Redirect to show_exam_result with the submission id
